...
describe FlickrPhotosImporter do
  ...
  describe "#perform" do
    ...
    context 'when photo cannot be created' do
      before do
        photo1 = Hashie::Mash.new(id: "photo1", owner: "owner1", profile_type: 'user', tags: nil, title: "title1", description: "tags are nil", datetaken: "2014-07-09 12:34:56", views: 100, url_o: "http://photo1", url_q: "http://photo_thumbnail1", dateupload: 9.days.ago.to_i)
